...
\begin{figure}[bth]
	\myfloatalign
	\subfloat[]
	{\includegraphics[width=.45\linewidth]{imagenes/c6/COPKM/Iris01}}
	\subfloat[]
	{\includegraphics[width=.45\linewidth]{imagenes/c6/COPKM/Rand01}}\\
	\subfloat[]
	{\includegraphics[width=.45\linewidth]{imagenes/c6/COPKM/IrisSoloML}}
	\subfloat[]
	{\includegraphics[width=.45\linewidth]{imagenes/c6/COPKM/RandSoloMl}}\\
...
\begin{figure}[bth]
	\myfloatalign
	\subfloat[Resultados para \textit{Iris Dataset}]
	{\includegraphics[width=.4\linewidth]{imagenes/c6/TVClust/TVIris}}
	\subfloat[Resultados para \textit{Rand Dataset}]
	{\includegraphics[width=.4\linewidth]{imagenes/c6/TVClust/TVRand}}
