...
\begingroup
    ...
    \begin{acronym}[UMLX]
    	...
    	\acro{ASS}{Aprendizaje Semi-Supervisado}
    	\acro{ANS}{Aprendizaje no Supervisado}
    	\acro{AR}{Aprendizaje por Refuerzo}
    	\acro{ML}{Must-Link}
    	\acro{CL}{Cannot-Link}
    	\acro{KM}{K-medias}
        ...
        \acro{MPCKM}{Metric Pairwise Constrained K - Means}
        \acro{CSP}{Constrained Spectral Clustering}
        \acro{CEVCLUS}{Constrained Evidential Clustering}
